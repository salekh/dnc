# Master Specification: MagentaTV "Continue Watching" Engine

This master specification coordinates all components of the MagentaTV Continue Watching recommendation service. It acts as the single source of truth (SSoT) tying together product requirements, technical design, implementation schedules, agent guidelines, and operational runbooks.

---

## 1. Document Directory Map

The MagentaTV personalized serving service codebase is structured under `/content/magenta-tv/`:

- **[prd.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/prd.md):** Defines target user stories, non-goals, and numeric metrics.
- **[design.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/design.md):** Defines the UI/UX layout, wireframe, and API contracts.
- **[plan.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/plan.md):** The 6-phase RPI implementation plan.
- **[GEMINI.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/GEMINI.md):** Banned libraries, house style guide, and sandbox boundaries.
- **[runbook.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/runbook.md):** The incident triage playbooks and remediation recipes.
- **Skills/Runbooks:**
  - **[deploy-recs-service.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/skills/deploy-recs-service.md):** Declarative deploy steps.
  - **[query-watch-history.md](file:///usr/local/google/home/sanchitalekh/Code/design-code-2/content/magenta-tv/skills/query-watch-history.md):** SQL lookup template.
