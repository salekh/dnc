...
The UI component is rendered as a horizontal scrollable rail on the MagentaTV homescreen. Below is the ASCII wireframe showing the layout with title, progress indicators, episode numbers, and personalized recommendation tags.
  ...
  "items": [
    {
      ...
      "thumbnail_url": "https://images.magenta-tv.de/thumbs/wl_s2_e4.jpg",
      ...
      "action_url": "magentatv://play?id=series_white_lotus_s2_ep4&t=2970"
    }
  ]
}
```
