# Product Requirement Document (PRD): Ruby TV "Continue Watching" Personalization Service

## 1. Overview
The "Continue Watching" rail is the central navigational element on the Ruby TV homescreen. It helps users resume content they have previously started, including movies, episodic TV shows, and live TV broadcasts. This PRD defines the requirements for upgrading this rail from a simple timestamp-sorted list to a personalized, context-aware recommendation service that optimizes for user retention and completion rates.
...
> **So that** when I turn on my Ruby TV smart TV app in the living room, I can resume the movie from the exact same frame.
